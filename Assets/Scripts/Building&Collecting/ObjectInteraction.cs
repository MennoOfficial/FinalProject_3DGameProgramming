...
public class ObjectInteraction : MonoBehaviour
{
    ...
    private string SolarPanelText = "Solar panels convert sunlight into electricity through photovoltaic cells. This sustainable technology harnesses the abundant and renewable energy from the sun, reducing the need for fossil fuels. Their low environmental impact makes them an essential component of sustainable energy systems.";
    ...
    void Update()
    {
        ...
        {
            UIManager.Instance.HideInfoButtonUI();
            UIManager.Instance.ShowInfoUI();
